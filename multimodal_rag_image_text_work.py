...
class ContributorsReferencesExtractor:
    ...
    def __init__(self, output_dir, contributors_pdf=None, references_pdf=None, index_pdf=None):
        ...
        Args:
            ...
            contributors_pdf: Path to PDF containing contributors (optional)
            references_pdf: Path to PDF containing references (optional)
            index_pdf: Path to PDF containing index (optional)
        """
